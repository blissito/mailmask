...
function convRowHtml(c, i) {
  {
    ...
    if (c.tags?.includes("spoof")) meta += `<span class="mesa-tag mesa-tag-deleted" title="Finge venir de tu dominio y falló DMARC">suplantación</span>`;
...
async function openConversation(conv) {
  ...
  document.getElementById("spoof-banner").classList.toggle("mesa-hidden", !conv.tags?.includes("spoof"));
